  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Municipality Officer Dashboard</h1>
              ...
              {applications.map((app) => (
                <tr key={app._id}>
                  ...
                  <td className="px-6 py-4">
                    <span className={`${getStatusColor(app.status)} text-white px-2 py-1 rounded-full text-xs`}>
