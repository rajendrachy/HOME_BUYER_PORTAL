           ...
           <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
              ...
              <div className="flex items-center gap-6 mb-4">
                 ...
                 <div className="flex flex-col gap-3">
                    <div className="px-6 py-2 bg-slate-900 text-white rounded-2xl text-xs font-black uppercase tracking-[0.2em] shadow-xl shadow-slate-900/10 w-fit">
                       #{application.applicationId}
                    </div>
                    <div className="flex gap-6 ml-1">
                       <div className="flex flex-col">
                          <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Submitted</span>
                          <span className="text-[11px] font-black text-slate-900">{new Date(application.createdAt).toLocaleDateString()}</span>
                       </div>
                       {application.approvedAt && (
                          <div className="flex flex-col border-l border-slate-100 pl-6">
                             <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Approved</span>
