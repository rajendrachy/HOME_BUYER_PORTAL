  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#fafbfc] selection:bg-blue-600 selection:text-white">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 ${
        scrolled ? "bg-white/80 backdrop-blur-xl shadow-sm py-4" : "bg-transparent py-8"
      }`}>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative hidden lg:block">
             <motion.div 
               ...
               className="relative z-10 rounded-[4rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(37,99,235,0.2)] aspect-[4/5] border-[12px] border-slate-50"
             >
                <img 
